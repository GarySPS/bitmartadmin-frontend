...
import AdminPasswordSettings from "../components/AdminPasswordSettings"; // The new component
import { motion, AnimatePresence } from "framer-motion";
import { Users, DollarSign, Settings, Banknote, PlusCircle, KeyRound } from "lucide-react"; // All icons imported here
...
  { key: "password", label: "Password", icon: <KeyRound size={18} className="mr-1 text-[#f9a825]" /> },
];
...
          )}
        ...
        {/* THIS IS THE FINAL MISSING PART THAT DISPLAYS THE NEW COMPONENT */}
        {activeTab === "password" && (
          <motion.div
            key="password"
            initial={{ opacity: 0, y: 32 }}
